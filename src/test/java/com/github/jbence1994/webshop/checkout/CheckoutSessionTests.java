...
public class CheckoutSessionTests {
    ...
    private static Stream<Arguments> checkoutSessionParams() {
        return Stream.of(
                Arguments.of(Named.of("Checkout session is not expired", checkoutSession()), false),
    ...
    public void fromTest() {
        ...
        assertThat(result, allOf(
                hasProperty("originalCartTotal", comparesEqualTo(checkoutSession().getOriginalCartTotal())),
                hasProperty("cartTotal", comparesEqualTo(checkoutSession().getCartTotal())),
