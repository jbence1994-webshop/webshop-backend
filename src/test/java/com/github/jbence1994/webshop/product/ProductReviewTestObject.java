...
public final class ProductReviewTestObject {
    public static ProductReview productReview1() {
        return new ProductReview(1L, product1(), profileWithoutAvatar(), PRODUCT_1_REVIEW, PRODUCT_1_REVIEW_CREATED_AT);
    }

    public static ProductReview productReview2() {
        return new ProductReview(2L, product1(), profileWithAvatar(), PRODUCT_2_REVIEW, PRODUCT_2_REVIEW_CREATED_AT);
    }
}
