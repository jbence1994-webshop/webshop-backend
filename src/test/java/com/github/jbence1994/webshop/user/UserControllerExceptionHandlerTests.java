...
public class UserControllerExceptionHandlerTests {
    ...
    private static Stream<Arguments> handleEmailOrPhoneNumberAlreadyExistsExceptionParams() {
        return Stream.of(
                Arguments.of(
                        Named.of("EmailAlreadyExistsException", new EmailAlreadyExistsException(EMAIL_1)),
    ...
    public void handleInvalidRecoveryCodeOrExpiredRecoveryCodeExceptionTest(RuntimeException exception, String expectedExceptionMessage) {
