...
public class FreeMarkerEmailTemplateBuilder implements EmailTemplateBuilder {
    ...
    public EmailContent buildForForgotPassword(String firstName, String temporaryPassword, Locale locale) {
        var subject = messageSource.getMessage("email.forgot-password.subject", new Object[]{webshopNameConfig.value()}, locale);
        ...
        model.put("webshopName", messageSource.getMessage("email.forgot-password.webshopName", new Object[]{webshopNameConfig.value()}, locale));
